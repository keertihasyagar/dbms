  ...
  <div class="container">
      <table class="data-table">
        ...
        <tbody>
          ...
          if (mysqli_multi_query($db, "SELECT transid ,transdate ,amount ,custid ,accno ,to_acc FROM trans where transdate >= DATE_ADD( '$date',INTERVAL -15 DAY)  order by transdate ")  or die('SQL Error: ' . mysqli_error($db))) {
              do {
